    ...
    <>
     <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  <span className="block text-2xl font-bold">{data?.totalClothes}</span>
              ...
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  <span className="block text-2xl font-bold">{data?.totalSales} Taka</span>
              ...
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  <span className="inline-block text-2xl font-bold">{data?.trendingClothes}</span>
                  <span className="inline-block text-xl text-gray-500 font-semibold">(13%)</span>
                  <span className="block text-gray-500">Trending Clothes in This Month</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
